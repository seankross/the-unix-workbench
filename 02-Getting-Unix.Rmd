...
If you're using MacOS or the Ubuntu operating system there is a default
program called **Terminal** find it and open it. You can skip the next section about
Windows.

## Windows

If you're using the latest version of Windows (Windows 10) you should install and enable
...
If you don't have the latest version of Windows you should download 

...
You can also climb several directories up with `cd (../){[a number of parent 
directories to climb up]}`. So if you start in `/Users/sean/Music` and there's a 
directory `/Users/mike/Pictures`, you can go to it with `cd ../../mike/Pictures`.

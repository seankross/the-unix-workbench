...
Now that you can fluidly use your terminal to bounce between directories all
...
for the file or folder. Let's rename `todo.txt` so that it includes today's date:

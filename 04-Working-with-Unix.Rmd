...
file to search. Let's see an simple example of `grep` in action and then I'll
...
letter "x" is printed to the console. As you can see, only two state names
contain the letter "x", New Mexico and Texas. Let's try searching for the letter
"q" in all of the state names using `grep`:

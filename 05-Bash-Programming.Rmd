...
An expression is just a valid string of Bash code that, when run, produces a result. The arithmetic
...
**owner** (`u`) of the file, the **group** (`g`) that the file belongs to, and **everyone** (`o`) other than

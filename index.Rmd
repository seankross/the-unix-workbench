...
This book is intended for folks who are new to programming and to Unix-like
...
interface. Command line interfaces can seem alien at first, so this book
...
discuss. My hope is that, by the end of this book, you will be able to use 
different Unix tools as if they are interconnecting Lego bricks.

Unix is over 40 years old, yet it is still used to power your phone,
the Internet, and the latest scientific research. It forms a foundation 
that is often very helpful for accomplishing other goals you might have for you
and your computer, whether that goal is running a business, writing a book, 
curing disease, or creating the next great app. The means to these goals are 
sometimes carried out by writing software.
